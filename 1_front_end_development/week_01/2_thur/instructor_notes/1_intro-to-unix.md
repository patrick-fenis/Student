...
While the GUI is perfect for the average computer user, there are few drawbacks:
...
![](https://i.imgur.com/PXKdEAP.png)

**helpful:**

![](https://i.imgur.com/yrQqV6S.png)
...
![Command Line Prompt](https://i.imgur.com/GEoP8hP.png)
...
![Command notfound](https://i.imgur.com/87u4gWW.png)
...
We're going to work through a couple of commands that you'll end up using almost every day as a developer. The commands
can be divided into two kinds of tasks: **Navigating** around the file system and
**working** with files and directories.

### Navigating the File System

Before we begin, here is a [cheatsheet](https://git.generalassemb.ly/SEI-Synchrony-11-22/student_resources/wiki/Unix-Commands-Cheatsheet) for the most basic commands we will use throughout the course.
...
Note the `/` before `Users`. That is the root. It's the top of
...
`/Users/seistudent`, which is helpful to save a lot of typing. :wink:
...
#### [You Do: Directory Tree](https://git.generalassemb.ly/pages/dc-wdi-fundamentals/directory-tree/)
...
```bash
$ cd /Users/seistudent # takes me to the home directory
$ cd ~ #takes me to the home directory
$ mkdir sei # makes a folder called sei in the current directory
$ mkdir /Users/seistudent/sei/2022 # makes a folder called 2021 in my ~/sei directory
...
location. We do not get a confirmation immediately after hitting enter.


### We do: Create SEI Environment
...
Make sure you are in your home directory, if not just run this command in the terminal => **`cd ~`**
...
### You do: Unix commands practice

Navigate to the `sandbox` folder we just created and create a new directory named `My-App`, inside that folder try to replicate the following structure.
...
## You do: Common Command Teachbacks
...
Essentially, we changed the `~/.bash_profile` or `~/.zshrc` to make your prompt into a better
one!
...
Let's open our `~/.bash_profile` or `~/.zshrc` in atom and type in the following...
...
## Other resources on terminal

There are also videos tutorials [here](https://www.youtube.com/playlist?list=PLdnONIhPScSToZztXRHyKZTQEsE30luMx)
