...
We would like to build applications that respond to user interactions. It's hard to escape website's today that aren't built with any sort of event listener. Let's make our applications more fun and useful with events!
...
We want to build applications that respond to our user's input: a user clicks a button, triggering an action in our
application.
...
> [Mozilla Developer Network](https://developer.mozilla.org/en-US/docs/Web/Events) and [W3 Schools](https://www.w3schools.com/jsref/dom_obj_event.asp) .
...
Let's discuss what is happening in
