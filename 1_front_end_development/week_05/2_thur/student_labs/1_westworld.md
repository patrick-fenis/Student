...
1. In the folder you created for today make a `student_labs` folder, then make a new file `oop_westworld.js`.
2. Give `oop_westworld.js` a console.log.
3. Set up like we usually do in class and open up the `index.html` in the browser. Verify the console log appears.
