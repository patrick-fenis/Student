...
1. You already created the HTML for this mockup last morning exercise. You should have it in your warm up folder from the last class. We called it `index.html`.
1. Let's copy your work into your student_examples folder for today.
1. In terminal:
    - navigate to your `/week_04/3_sat/warm_up/vssl_mockup` folder
    - from there type `cp ../../../2_thur/warm_up/vssl_mockup/*.html .`
