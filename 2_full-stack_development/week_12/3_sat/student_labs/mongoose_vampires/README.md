...
1. navigate to this directory `afternoon_lab` in terminal and `npm i` to install `mongoose`
1. open the project in your text editor, you'll be working with some starter code in the `models` folder and the `app.js` file
...
1. Delete a single document wherein the hair_color is 'brown'
